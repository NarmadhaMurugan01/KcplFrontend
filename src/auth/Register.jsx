...
const Register = () => {
  ...
  console.log('mobile_no',phone_valid);
  ...
  const paragraphs = [
    ...
    <div className="bottom" ref={bottomRef}>
      ...
      <p style={{ color: "red" }}>{error}</p>
          ...
          {/* <div style={{ border: '2px solid red ',width: '350px' , }}> */}
          <div >
          ...
          placeholder="Enter phone number"
            ...
            style={{
                border: touchedFields.mobile_no && mobileError ? "2px solid red" : "2px solid #bbb9b9",
                borderRadius: touchedFields.mobile_no && mobileError ? "5px" : "5px"
            }}
/>
